    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                ...
                <div>
                    <h4 class="logo-text text-light">Portal Sayur</h4>
                </div>
                <div class="toggle-icon ms-auto text-light"><i class='text-light bx bx-arrow-to-left'></i>
                </div>
            </div>
            <!--navigation-->
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="<?= base_url('petani/tanaman') ?>">
                        <div class="parent-icon"><i class="bx bx-bug-alt"></i>
                        </div>
                        <div class="menu-title">Tanaman</div>
                    </a>
                </li>
            </ul>
            <!--end navigation-->
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="user-info ps-3">
                                <p class="user-name mb-0 text-light"><?= session('user')->username ?></p>
                                <p class="designattion mb-0 text-light">Petani</p>
                            </div>
                        </a>
